...
import com.himanshu.kumar.LaughApi.service.UserService;
...
public class AuthenticationController {
    ...
    @Operation(summary = "Create a user account", description = "Creates a unique user record in the system corresponding to the provided information")
    @ApiResponses(value = {
    ...
    public ResponseEntity<TokenSuccessResponseDto> login(@Valid @RequestBody final UserLoginRequestDto userLoginRequestDto) {
        final var response = userService.login(userLoginRequestDto);
