...
public class UserLoginRequestDto {
    ...
    @Schema(requiredMode = RequiredMode.REQUIRED, example = "himanshu.kumar@gmail.com", description = "email-id associated with user account already created in the system")
